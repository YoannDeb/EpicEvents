...
class EventSerializer(serializers.ModelSerializer):
    """
    Event serializer, with client and support contact info added as read_only fields.
    """
    ...
    class Meta:
        ...
        fields = ['id', 'client', 'client_first_name', 'client_last_name', 'client_email', 'date_created',
                  'date_updated', 'status', 'attendees', 'event_date', 'notes', 'support_contact',
                  'support_contact_first_name', 'support_contact_last_name', 'support_contact_email']
